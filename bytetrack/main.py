...
if __name__ == '__main__':
    ...
    while True:
        ...
        outputs, img_info, clsnames = predictor.inference(frame)
        ...
        if outputs is not None:
            ...
            online_im = plot_tracking(
                img_info['raw_img'], online_tlwhs, online_ids, frame_id=frame_id + 1, fps=frame_fps,classes=cls,score=scores,clsnames=clsnames
            )
